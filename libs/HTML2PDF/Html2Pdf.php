...
require_once(dirname(__FILE__).'/../Dependencies/TCPDF/tcpdf.php');
require_once(dirname(__FILE__).'/../Dependencies/TCPDF/tcpdf_parser.php');
require_once(dirname(__FILE__).'/../Dependencies/TCPDF/tcpdf_import.php');
require_once(dirname(__FILE__).'/../Dependencies/TCPDF/tcpdf_barcodes_1d.php');
require_once(dirname(__FILE__).'/../Dependencies/TCPDF/tcpdf_barcodes_2d.php');
require_once(dirname(__FILE__).'/../Dependencies/TCPDF/include/tcpdf_colors.php');
require_once(dirname(__FILE__).'/../Dependencies/TCPDF/include/tcpdf_filters.php');
require_once(dirname(__FILE__).'/../Dependencies/TCPDF/include/tcpdf_font_data.php');
require_once(dirname(__FILE__).'/../Dependencies/TCPDF/include/tcpdf_fonts.php');
require_once(dirname(__FILE__).'/../Dependencies/TCPDF/include/tcpdf_images.php');
require_once(dirname(__FILE__).'/../Dependencies/TCPDF/include/tcpdf_static.php');
require_once(dirname(__FILE__).'/../Dependencies/TCPDF/include/barcodes/datamatrix.php');
require_once(dirname(__FILE__).'/../Dependencies/TCPDF/include/barcodes/pdf417.php');
require_once(dirname(__FILE__).'/../Dependencies/TCPDF/include/barcodes/qrcode.php');
